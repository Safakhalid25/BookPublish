...
import titleone from "../../Assets/images/titleone.png";
import titlesix from "../../Assets/images/titlesix.png";
import titlefive from "../../Assets/images/titlefive.png";
import titlefour from "../../Assets/images/titlefour.png";
import titlethree from "../../Assets/images/titlethree.png";
import titletwo from "../../Assets/images/titletwo.png";
    ...
    <UserLayout>
      <>
          ...
          <div className="container">
            <div className="row">
              <div className="herro__title">
                ...
                <div  className="hero_title_divider"></div>
                <div  className="hero_title_divider"></div>
                <h5 className="chapter_title_typewriter">CHAPTER TITLE</h5>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="discussion_section">
            <div className="container">
                <div className="row">
                    <div className="col-md-4 chap_title_box_space">
                        <img src={titleone} className="img-fluid title_imgs"/>
                    </div>
                    <div className="col-md-4 chap_title_box_space">
                        <img src={titletwo} className="img-fluid title_imgs"/>
                    </div>
                    <div className="col-md-4 chap_title_box_space">
                        <img src={titlethree} className="img-fluid title_imgs"/>
                    </div>
                </div>
                <div className="row mt-3">
                    <div className="col-md-4 chap_title_box_space">
                        <img src={titlefour} className="img-fluid title_imgs"/>
                    </div>
                    <div className="col-md-4 chap_title_box_space">
                        <img src={titlefive} className="img-fluid title_imgs"/>
                    </div>
                    <div className="col-md-4 chap_title_box_space">
                        <img src={titlesix} className="img-fluid title_imgs"/>
                    </div>
                </div>
            </div>
        </section>
