...
export const MyAccount = () => {
  ...
  const ProfileData = () => {
    fetch(
      "https://custom.mystagingserver.site/Tim-WDLLC/public/api/user/view-profile",
      {
        method: "GET",
        headers: {
  ...
  const GetLibrary = () => {
    document.querySelector(".loaderBox").classList.remove("d-none");
    fetch(
      `https://custom.mystagingserver.site/Tim-WDLLC/public/api/user/wish-list`,
      {
        method: "GET",
        headers: {
          Accept: "application/json",
  ...
  const paymentSend = (tokenData) => {
    ...
    fetch(
      "https://custom.mystagingserver.site/Tim-WDLLC/public/api/user/mana-purchase",
      {
        method: "POST",
        headers: {
          Accept: "application/json",
                        ...
                        <div className="row">
                          <div className="col-12">
                            <div className="dashCards">
                              <div className="row">
                                <div className="col-12">
                                  <CustomTable headers={libraryKeys}>
                                    <tbody>
                                      {library?.map((item, index) => (
                                        <tr key={index}>
                                          ...
                                          <td>
                                            {item?.wish_book?.chapters.length}
                                          </td>
