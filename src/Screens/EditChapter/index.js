  ...
  return (
    <UserLayout>
      <>
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-12">
                ...
                <h5 className="edit_chapter_name">
        ...
        <section className="edit_chap_box_border">
          <div className="container">
            <div className="row">
              <div className="col-md-12">
                <div className="edit_chap_box_one">
                  <buton className="change_price_btn">
                    Change Price
                  </buton>
                  <buton className="update_content_btn">
                    Update
                  </buton>
                </div>
              </div>
