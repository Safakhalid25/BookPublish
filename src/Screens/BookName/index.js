        ...
        >
          <div class="modal-dialog modal-dialog-centered cust_modal_dailog">
            <div class="modal-content audio_modal_bg">
              ...
              <div class="modal-body ">
                <div className="row position-relative">
                  ...
                  <div className="col-md-7">
                    ...
                    <div className="pitch_range_slider_div">
                      <p className="pitch_range_text">PITCH</p>
                      <RangeSlider
                        className="pitch_range"
              ...
              <div class=" audio_manage_box">
                <RangeSlider
                  className="audio_range"
                  onChange={(e) => setValue(e.target.value)}
                />
                <div className="audio_cntrl_options">
                  <i class="fa-solid fa-chevron-left audio_ctrl_icon"></i>
                  <i class="fa-solid fa-pause play_ctrl_icon"></i>
                  <i class="fa-solid fa-chevron-right audio_ctrl_icon"></i>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="modal-dialog custom_modal_dailog">
            <div class="modal-content purchased_modal-content">
              ...
              <div class="modal-body modal_body_spacing">
                ...
                <div className="purchased_chap_cards">
                  <p className="read_ahead">Read 5 chapters </p>
                  <div className="read_ahead_main_div">
                    <p className="read_ahead_para">
                      Purchase to unlock 2 chapters in advance
                    </p>
                ...
                <div className="purchased_chap_cards">
                  <p className="read_ahead">Read 10 chapters </p>
                  <div className="read_ahead_main_div">
                    <p className="read_ahead_para">
                      Purchase to unlock 2 chapters in advance
                    </p>
                ...
                <div className="purchased_chap_cards">
                  <p className="read_ahead"> Read 20 chapters </p>
                  <div className="read_ahead_main_div">
                    <p className="read_ahead_para">
                      Purchase to unlock 2 chapters in advance
                    </p>
