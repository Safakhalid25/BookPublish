...
export const CreateChapterManga = () => {
      ...
      <>
        ...
        >
          <div className="publish_chap_modal">
            <Modal.Body>
              <h3 className="publish_chap_manga_title">
                {" "}
                Publish Chapter{" "}
                <span className="manga_publish_title">MANGA</span>
              </h3>
              <div className="row mt-3 align-items-center">
                <div className="col-lg-6">
                  ...
                  <div className="publish_btn_div">
                    <button className="save_publish_btn">
                      Submit & Preview Chapter
                    </button>
                    <button
                ...
                <div className="col-lg-6">
                  <div className="file_upload_box">
                    <img src={fileUpload} className="file_upload_img" />
                    <p className="select_file_text">
                      Select a file or drop here
                    </p>
                    <label class="file_upload_btn" for="file-upload">
                      Upload
                    </label>
                    <input
                      type="file"
                      ...
                      style={{ display: 'none' }}
                    />
                    {/* <button className="file_upload_btn">Upload</button> */}
                  </div>
                </div>
              </div>
            </Modal.Body>
